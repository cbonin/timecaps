...
define('CGU'		, "Privacy policy");
define('A_PROPOS'	, "About");
//---------------------------------------------------------
...
define('REMPLISSEZ'		, "Please, fill this form");
//---------------------------------------------------------
...
// edition boite
//---------------------------------------------------------
define('CONTENU'		, "Contents of the box");
define('CONTRIBUTEURS'	, "Contributors");
//---------------------------------------------------------
...
define('TXT_IN_BW'	, "To use Backwards, just fill this form to sign up...");
define('TXT_IN_FB'	, "...or save time with Facebook");
//---------------------------------------------------------
...
// boutnons
//---------------------------------------------------------
define('BTN_ENVOYER'	, "Send");
define('BTN_RETOUR'		, "Back");
define('BTN_ENREGISTRER', "Save modifications");
define('BTN_CREER'		, "New box");
