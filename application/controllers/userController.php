...
class userController extends CI_Controller
{
	...
	function signUp()
	{
		...
		$this->form_validation->set_rules('password', 'Mot de passe', 'trim|required|xss_clean|matches[passwordConf]');
		$this->form_validation->set_rules('passwordConf', 'confirmation mot de passe', 'trim|required|xss_clean');
